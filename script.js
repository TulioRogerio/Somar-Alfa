document.addEventListener("DOMContentLoaded", function () {
  // Obtém a URL base do site (ajuste conforme necessário)
      ...
      <ul class="menu">
        ...
        <li>
          ...
          <ul class="submenu">
            ...
            <li><a href="${basePath}gestao-usuarios/ativacao-inativacao.html">Ativação, Inativação e Login</a></li>
...
function ativarEventosMenu() {
  ...
  menuItems.forEach(item => {
    item.addEventListener("click", function (event) {
      ...
      // Se não tiver submenu, deixa o link navegar normalmente
    });
  });
}
